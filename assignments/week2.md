...
(b) Consider the symmatric Dirichlet distributions Dir(<1,1,1>),  Dir(<2,2,2>), and Dir(<0.1,0.1,0.1>). Rank them by entropy.  Explain.  See page 3 of the following tutorial for images: http://mayagupta.org/publications/FrigyikKapilaGuptaIntroToDirichlet.pdf
